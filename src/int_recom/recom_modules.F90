...
!! *** General constants ***
  ...
  integer, dimension(2)  :: recom_zoo2_tracer_id    = (/1023, 1024/)
...
!!MB TEST: tracer ids for revised remineralization and sinking in oce_ale_tracer.F90
  ...
  !integer, dimension(3)  :: recom_cocco_tracer_id   = (/1029, 1030, 1031/)
  !integer, dimension(3)  :: recom_phaeo_tracer_id   = (/1032, 1033, 1034/) ! Phaeo
  !integer, dimension(4)  :: recom_det2_tracer_id    = (/1025, 1026, 1027, 1028/)
...
!! *** Phytoplankton ChlA ***
  ...
  Real(kind=8)                 :: deg_Chl_p     = 0.25d0          ! Phaeocystis (to be tuned)
...
!! *** CO2 dependence of rates ! NEW CO2 ***
  ...
  Real(kind=8)  :: DiaCO2
  Real(kind=8)  :: PhyCO2
  Real(kind=8)  :: PhaeoCO2               ! Phaeocystis
...
!! *** Zooplankton ***
  ...
  Real(kind=8)  :: PhaeoNsq                                            ! Phaeocystis
  Real(kind=8)  :: varpzPhaeo,fPhaeoN                                  ! Phaeocystis
...
Module REcoM_GloVar
  ...
  Real(kind=8),allocatable,dimension(:,:)   :: GlowFluxPhaeo  ! Phaeocystis
